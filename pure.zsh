...
prompt_pure_preprompt_render() {
	...
	# BRET change - use blue on yell color scheme, with powerline font arrow at end
	local preprompt="%{%K{yellow}%}%{%F{blue}%} %~ %{%K{black}%F{yellow}%}\ue0b0%f"
	# git info
...
prompt_pure_setup() {
	...
	# BRET change - include Powerline font branch character \ue0a0
